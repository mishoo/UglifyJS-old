        ...
        function tighten(statements, block_type) {
                ...
                statements = (function(a, prev) {
                        statements.forEach(function(cur){
                                if (!(prev && prev[0] == "stat" && prev[1][0] == "assign")) {
                                        a.push(cur);
                                        prev = cur;
                                        return;
                                }
                                ...
                                if (c && find_assign_recursive(p, c)) {
                                        ...
                                        tmp_cur = best_of(cur, [ "toplevel", [ prev, old_cur ] ]);
                                        if (tmp_cur == cur) {
                                                a[a.length -1] = cur;
                                        } else {
                                                cur = old_cur;
                ...
                statements = (function(a, prev){
                        statements.forEach(function(cur){
                                var c = (cur[0] == "for") ? cur[1] : cur;
                                if (prev && c && ((c[0] == "var" && prev[0] == "var") ||
                                                  (c[0] == "const" && prev[0] == "const"))) {
                                        c[1] = prev[1].concat(c[1])
                                        a[a.length - 1] = cur;
                                } else {
                                        a.push(cur);
                                }
                ...
                if (options.make_seqs) statements = (function(a, prev) {
                        statements.forEach(function(cur){
                                var is_stat = (cur[0] == "stat" || (cur[0] == "for" && cur[1] && cur[1][0] != "var" && cur[1][0] != "const"));

                                if (is_stat && prev && prev[0] == "stat") {
                                        cur[1] = [ "seq", prev[1], cur[1] ];
                                        a[a.length - 1] = cur;
                                } else {
                                        a.push(cur);
                                }
