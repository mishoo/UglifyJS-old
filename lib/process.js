        ...
        return with_new_scope(function(){
                ...
                function fixrefs(scope, i) {
                        ...
                        for (i in scope.refs) if (HOP(scope.refs, i)) {
                                ...
                                // we must also propagage it to the origin scope!
                                while (s && s !== origin) {
                                        s.refs[i] = origin;
                                        s = s.parent;
                                }
                ...
                // sys.puts(sys.inspect(current_scope, null, null));
...
function ast_squeeze(ast) {
        ...
        function aborts(t) {
                ...
                if (t[0] == "return" || t[0] == "break" || t[0] == "continue")
                        return true;
        };
...
function gen_code(ast, beautify) {
        ...
        var generators = {
                ...
                "unary-prefix": function(operator, expr) {
                        var val = make(expr);
                        if (!(HOP(jsp.ATOMIC_START_TOKEN, expr[0]) || expr[0] == "dot" || expr[0] == "call"))
                                val = "(" + val + ")";
